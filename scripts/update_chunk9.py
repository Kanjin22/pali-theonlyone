...
for i, line in enumerate(lines):
    ...
    # 3. Update อาจริยฏฺฐาน (using ฏฺฐาน)
    if '"อาจริยฏฺฐาน":' in line:
        new_lines.append('  "อาจริยฏฺฐาน": "น.,นปุ. ฐานะ (ตำแหน่ง) แห่ง อาจารย์แจกเหมือน กุล เช่น ส.เอก. อาจริยฏฺ- ฐาเน ในฐานะแห่งอาจารย์ เป็นฉัฏฐีตัปปุริส สมาส วิ.ว่า อาจริยสฺส ฐานํ = อาจริยฏฺฐานํ [ซ้อน ฏฺ]",\n')
        continue
