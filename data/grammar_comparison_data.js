const grammarComparisonData = [
    ...
    // =========================================================
    {
        ...
        formulas: [
            ...
            { padarupasiddhi: { pali: "อกฺขราปาทโย เอกจตฺตาลีสํ.", ref: "ปท. ๒" }, kaccayana: { ref: "กัจ. ๒" } },
            { padarupasiddhi: { pali: "ตตฺโถทนฺตา สรา อฏฺฐ.", ref: "ปท. ๓" }, kaccayana: { ref: "กัจ. ๓" } },
            { padarupasiddhi: { pali: "ลหุมตฺตา ตโย รสฺสา.", ref: "ปท. ๔" }, kaccayana: { ref: "กัจ. ๔" } },
            { padarupasiddhi: { pali: "อญฺเญ ทีฆา.", ref: "ปท. ๕" }, kaccayana: { ref: "กัจ. ๕" } },
            { padarupasiddhi: { pali: "ทุมฺหิครุ.", ref: "ปท. ๖" } },
            { padarupasiddhi: { pali: "ทีโฆ จ.", ref: "ปท. ๗" } },
            { padarupasiddhi: { pali: "เสสา พฺยญฺชนา.", ref: "ปท. ๘" } },
            { padarupasiddhi: { pali: "วคฺคา ปญฺจปญฺจโส มนฺตา.", ref: "ปท. ๙" } },
            { padarupasiddhi: { pali: "อํอิตินิคฺคหีตํ.", ref: "ปท. ๑๐" } },
            { padarupasiddhi: { pali: "ปรสมญฺญา ปโยเค.", ref: "ปท. ๑๑" } },
            { padarupasiddhi: { pali: "ปุพฺพมโธฐิตมสฺสรํสเรน วิโยชเย.", ref: "ปท. ๑๒" } },
            { padarupasiddhi: { pali: "สรา สเร โลปํ.", ref: "ปท. ๑๓" } },
            { padarupasiddhi: { pali: "นเย ปรํยุตฺเต.", ref: "ปท. ๑๔" } },
            { padarupasiddhi: { pali: "วา ปโร อสรูปา.", ref: "ปท. ๑๕" } },
            { padarupasiddhi: { pali: "กฺวจาสวณฺณํลุตฺเต.", ref: "ปท. ๑๖" } },
            { padarupasiddhi: { pali: "ทีฆํ.", ref: "ปท. ๑๗" } },
            { padarupasiddhi: { pali: "ปุพฺโพ จ.", ref: "ปท. ๑๘" } },
            { padarupasiddhi: { pali: "ยเมทนฺตสฺสาเทโส.", ref: "ปท. ๑๙" } },
            { padarupasiddhi: { pali: "วโมทุทนฺตานํ.", ref: "ปท. ๒๐" } },
            { padarupasiddhi: { pali: "อิวณฺโณ ยํนวา.", ref: "ปท. ๒๑" } },
            { padarupasiddhi: { pali: "สพฺโพ จนฺติ.", ref: "ปท. ๒๒" } },
            { padarupasiddhi: { pali: "อติสฺส จนฺตสฺส", ref: "ปท. ๒๓" } },
            { padarupasiddhi: { pali: "อพฺโภ อธิ.", ref: "ปท. ๒๔" } },
            { padarupasiddhi: { pali: "อชฺโฌ อธิ.", ref: "ปท. ๒๕" } },
            { padarupasiddhi: { pali: "เต น วา อิวณฺเณ.", ref: "ปท. ๒๖" } },
            { padarupasiddhi: { pali: "โท ธสฺส จ.", ref: "ปท. ๒๗" } },
            { padarupasiddhi: { pali: "เอวาทิสฺส ริปุพฺโพ จ รสฺโส.", ref: "ปท. ๒๘" } },
            { padarupasiddhi: { pali: "อิวณฺณุวณฺณา ฌลา.", ref: "ปท. ๒๙" } },
            { padarupasiddhi: { pali: "ฌลานมิยุวา สเร วา.", ref: "ปท. ๓๐" } },
            {
                kaccayana: {
