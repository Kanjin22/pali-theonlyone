const grammarComparisonData = [
    ...
    {
        padarupasiddhi: {
            pali: "ยว ม ท น ต ร ลา จาคมา.",
            ref: "ปท. ๓๔"
        }
    },
    {
        padarupasiddhi: {
            pali: "กฺวจิโอ พฺยญฺชเน.",
            ref: "ปท. ๔๗"
        }
    },
    {
        padarupasiddhi: {
            pali: "วคฺคนฺตํวา วคฺเค.",
            ref: "ปท. ๔๙"
        }
    },
    {
        ...
        formulas: [
            {
                ...
                padarupasiddhi: {
                    pali: "ตพฺพิปรีตูปปเท พฺยญฺชเน จ.",
    ...
    // =========================================================
    {
        topic: "ตารางที่ ๗. กิพฺพิธานกณฺโฑ",
        formulas: [
            {
                kaccayana: {
...
const sandhiTable1Data = [
    {
        ...
        formulas: [
            ...
            },
            {
                ...
                padarupasiddhi: {
            pali: "ปรสมญฺญา ปโยเค.", ref: "ปท. ๑๑" }
            },
            {
                kaccayana: { pali: "ปุพฺบมโธฐิตมสฺสรํ สเรน วิโยชเย.", ref: "กัจ. ๑๐" },
                padarupasiddhi: {
            pali: "ปุพฺพมโธฐิตมสฺสรํสเรน วิโยชเย.", ref: "ปท. ๑๒" }
            },
            {
            ...
            },
            {
                ...
                padarupasiddhi: {
            pali: "สรา ปกติพฺยญฺชเน.", ref: "ปท. ๓๖" }
            },
            {
                kaccayana: { pali: "สเร กฺวจิ.", ref: "กัจ. ๒๔" },
                padarupasiddhi: {
            pali: "สเร กฺวจิ.", ref: "ปท. ๓๕" }
            },
            {
...
const namaTable2Data = [
    {
        ...
        formulas: [
            ...
            },
            {
                ...
                padarupasiddhi: {
            pali: "อิวณฺณุวณฺณา ฌลา.", ref: "ปท. ๒๙" }
            },
            {
            ...
            },
            {
                ...
                padarupasiddhi: {
            pali: "ฌลานมิยุวา สเร วา.", ref: "ปท. ๓๐" }
            },
            {
            ...
            },
            {
                ...
                padarupasiddhi: {
            pali: "โอ สเร จ.", ref: "ปท. ๓๑" }
            },
            {
                kaccayana: { pali: "ตพฺบิปรีตูปปเท พฺยญฺชเน จ.", ref: "กัจ. ๗๙" },
                padarupasiddhi: {
            pali: "ตพฺพิปรีตูปปเท พฺยญฺชเน จ.", ref: "ปท. ๔๖" }
            },
            {
            ...
            },
            {
                ...
                padarupasiddhi: {
            pali: "ยวตํตลนทการานํพฺยญฺชนานิจลญชการตฺตํ.", ref: "ปท. ๔๑" }
            },
            {
...
const karakaTable3Data = [
    {
        ...
        formulas: [
            ...
            { kaccayana: { pali: "สิลาฆหนุฐาสปธารปิหกุธทุหิสฺโสสูยราธิกฺขปจฺจาสุณ อนุปติคิณ ปุพฺบกตฺตาโรจนตฺถตทตฺถตุมตฺถาลมตฺถ มญฺญานาทรปฺปาณินิคตฺยตฺถกมฺมนิ อาสิสตฺถสมฺมุติ ภิยฺยสตฺตมฺยตฺเถสุ จ.", ref: "กัจ. ๒๗๗" }, padarupasiddhi: { ref: "ปท. ๓๐๓" } },
            ...
            { kaccayana: { pali: "อิติ นามกปฺเป การกกณฺโฑ." } },
...
const samasaTable4Data = [
    {
        ...
        formulas: [
            ...
            { kaccayana: { pali: "อิติ นามกปฺเป สมาสกณฺโฑ สตฺตโม กณฺโฑ." } },
...
const kittaTable7Data = [
    {
        ...
        formulas: [
            ...
            { kaccayana: { pali: "ทุมฺหิ ครุ.", ref: "กัจ. ๖๐๒" }, padarupasiddhi: {
            pali: "ทุมฺหิคร.", ref: "ปท. ๖" } },
            { kaccayana: { pali: "ทีโฆ จ.", ref: "กัจ. ๖๐๓" }, padarupasiddhi: {
            pali: "ทีโฆ จ.", ref: "ปท. ๗" } },
...
const unadiTable8Data = [
    {
        ...
        formulas: [
            ...
            { kaccayana: { pali: "อิติ กิพฺพิธานกปฺเป อุณาทิกณฺโฑ ฉฏฺโฐ กณฺโฑ." } },
